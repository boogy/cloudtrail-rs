...
| 18 | MiniStack integration tests | 16 | dispatched | — | Sonnet subagent: docker-compose.test.yml (ministack :4566) + crates/aws/tests/ministack.rs, all #[ignore]d; real S3ObjectStore/SsmConfigSource, buffer + stream/multipart objects |
